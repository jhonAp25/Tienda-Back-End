...
insert into talla values (null, 'XXXL');


insert into tipo_producto values (null,'tipo01');
...
insert into tipo_producto_modelo  values ( 1 , 3 );
insert into tipo_producto_modelo  values ( 1 , 4 );

insert into tipo_producto_modelo  values ( 2 , 5 );
insert into tipo_producto_modelo  values ( 2 , 6 );
insert into tipo_producto_modelo  values ( 2 , 7 );
insert into tipo_producto_modelo  values ( 2 , 8 );

insert into tipo_producto_modelo  values ( 3 , 9 );
insert into tipo_producto_modelo  values ( 3 , 10 );
insert into tipo_producto_modelo  values ( 3 , 11 );
insert into tipo_producto_modelo  values ( 3 , 12 );

insert into gastos values (null, 50.5 , '2021-08-20' , 'tela datoka' );
insert into gastos values (null, 50.5 , '2021-08-20' , 'tela acolchado' );
insert into gastos values (null, 50.5 , '2021-08-20' , 'tela win' );
